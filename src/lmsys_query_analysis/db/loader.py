...
def load_dataset(
    ...
    """Load query dataset into the database using a data source adapter.

    Args:
        db: Database instance
        adapter: Data source adapter (e.g., HuggingFaceAdapter, CSVAdapter)
    ...
    with Progress(
        ...
        try:
            ...
            # Iterate records from adapter and build rows in batches
            for batch in chunk_iter(adapter.iter_records(limit=limit), BATCH_SIZE):
