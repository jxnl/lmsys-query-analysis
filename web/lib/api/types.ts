...
export interface paths {
    ...
    "/api/hierarchy/{hierarchy_run_id}/metadata": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get hierarchy run metadata
         * @description Get detailed metadata for a hierarchy run.
         *
         *     Returns configuration, parameters, and execution metadata for the hierarchy run.
         */
        get: operations["get_hierarchy_run_metadata_api_hierarchy__hierarchy_run_id__metadata_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/summaries/{summary_run_id}/metadata": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get summary run metadata
         * @description Get detailed metadata for a summary run.
         *
         *     Returns configuration, parameters, and execution metadata for the summary run.
         */
        get: operations["get_summary_run_metadata_api_summaries__summary_run_id__metadata_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * HierarchyRunDetail
         * @description Detailed hierarchy run with metadata.
         */
        HierarchyRunDetail: {
            /** Hierarchy Run Id */
            hierarchy_run_id: string;
        ...
        /**
         * SummaryRunDetail
         * @description Detailed summary run with metadata.
         */
        SummaryRunDetail: {
            /** Summary Run Id */
            ...
            rpm?: number | null;
            /** Contrast Neighbors */
            contrast_neighbors: number;
            /** Contrast Examples */
            contrast_examples: number;
            /** Contrast Mode */
...
export interface operations {
    ...
    get_hierarchy_run_metadata_api_hierarchy__hierarchy_run_id__metadata_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["HierarchyRunDetail"];
                };
            };
            /** @description Not Found */
            404: {
    ...
    get_summary_run_metadata_api_summaries__summary_run_id__metadata_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SummaryRunDetail"];
                };
            };
            /** @description Not Found */
            404: {
