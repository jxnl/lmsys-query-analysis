...
def test_move_query_command(mock_get_db, mock_curation_service):
    ...
    # Mock move result
    mock_curation_service.move_query.return_value = {
        "from_cluster_id": 1,
        "to_cluster_id": 2
    }
...
def test_delete_cluster_command(mock_get_db):
    ...
    from lmsys_query_analysis.db.models import QueryCluster, ClusterSummary
...
def test_audit_command(mock_get_db):
    ...
    from lmsys_query_analysis.db.models import Query, QueryCluster
