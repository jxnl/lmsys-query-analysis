...
def test_list_clusters_command(mock_get_db):
    ...
    with patch('lmsys_query_analysis.cli.commands.analysis.cluster_service') as mock_cluster_service:
...
def test_inspect_cluster_command(mock_get_db, mock_cluster_service, mock_query_service):
    ...
    from lmsys_query_analysis.db.models import Query, ClusterSummary
